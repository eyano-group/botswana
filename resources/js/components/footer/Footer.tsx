    ...
    <footer className="main-footer bg-[#0c2136]">
      <div className="auto-container max-w-7xl mx-auto px-4">
            ...
            <div className="flex flex-wrap -mx-4">
                ...
                <div className="footer-widget logo-widget relative lg:-mr-9 lg:mt-1">
                  ...
                  <div className="text">
                    <p className="text-gray-400 leading-6 mb-6">
                      We provide reliable and professional immigration guidance
                      to help you navigate every step with confidence. Our team
                      is committed to delivering accurate information,
                      personalized support, and a seamless experience from start
                      to finish.
                    </p>
                  </div>
                  ...
                  <ul className="social-links flex">
                    <li className="mr-4 last:mr-0">
                      <Link
                        href="/"
                        className="text-gray-400 text-base hover:text-[#0099cc] transition-colors duration-300"
                      >
              ...
              <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0">
                <div className="footer-widget links-widget lg:ml-15">
                  <div className="widget-title relative mb-6">
                    <h3 className="text-xl lg:text-2xl font-bold text-white m-0">
                      Immigration
                    </h3>
                  </div>
                  <div className="widget-content">
                    <ul className="list">
                      <li className="relative block mb-2 last:mb-0">
                        <Link
                          href="/"
                          className="relative inline-block text-gray-400 text-sm leading-6 font-light pl-6 hover:text-white transition-colors duration-300"
                        >
                          Pre Assessment
                          <span className="absolute left-0 top-1 text-xs text-gray-400 transition-colors duration-300 hover:text-white">
                            ›
                          </span>
                        </Link>
                      </li>
              ...
              <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0">
                <div className="footer-widget newsletter-widget lg:-ml-2.5">
                  ...
                  <div className="widget-content">
                    <p className="text-gray-400 leading-6 mb-6">
                      Enter your email address to get latest updates and offers
        ...
        <div className="footer-bottom relative py-10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="copyright text-gray-400 leading-6 mb-4 md:mb-0">
              <p>
                ...
                <Link
                  href="/"
                  className="text-gray-400 uppercase hover:text-[#0099cc] transition-colors duration-300"
                >
                  Botswana
                </Link>{" "}
                Immigration & Visa Firm. All rights reserved.
              </p>
            </div>
            <ul className="footer-nav flex flex-wrap">
              <li className="relative inline-block mr-5 last:mr-0">
                <Link
                  href="/"
                  className="text-gray-400 text-sm leading-6 font-light hover:text-white transition-colors duration-300"
                >
                  Privacy Policy
          ...
          {/* Ajout de la mention EyanoGrp */}
          <div className="flex justify-center mt-6">
            <p className="text-gray-500 text-xs">
              Powered by{" "}
              <a
                href="https://eyanogrp.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#0099cc] hover:text-[#0080b3] transition-colors duration-300 font-medium"
              >
                EyanoGrp
              </a>
            </p>
