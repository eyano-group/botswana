...
const EventCard = ({ title, date, time, location, description }) => {
  return (
    <div className="flex bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
      {/* Badge de date */}
      <div className="flex-shrink-0 w-32 bg-gradient-to-br from-blue-600 to-blue-700 text-white p-4 text-center flex flex-col justify-center items-center">
      ...
      <div className="flex-grow p-6 flex flex-col justify-between">
        ...
        <a href="#" className="inline-flex items-center text-blue-600 font-semibold hover:text-blue-800 mt-4 transition-colors">
