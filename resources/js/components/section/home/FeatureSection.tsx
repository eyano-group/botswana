...
const FeatureSection = () => {
  ...
  const features = [
    {
      id: 1,
      // Okavango Delta — Photo : Joachim Huber (via Wikimedia Commons)
      // Licence: CC BY-SA 2.0 — Attribution requise.
      // Source page: https://commons.wikimedia.org/wiki/File:Okavango_Delta,_Botswana_(2674373339).jpg
      image:
        "https://upload.wikimedia.org/wikipedia/commons/b/b1/Okavango_Delta%2C_Botswana_%282674373339%29.jpg",
      alt: "Okavango Delta, Botswana — paysage d’eau et zones humides",
      title: "Apply Visa Online",
      href: "https://evisa.gov.bw/",
      description:
        "Complete your visa application from the comfort of your home with our streamlined online process designed for Botswana residents.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      id: 2,
      // Buffalo / Chobe National Park — Photo : Bernard Gagnon (via Wikimedia Commons)
      // Licence: CC BY-SA 4.0 — Attribution requise.
      // Source page: https://commons.wikimedia.org/wiki/File:African_buffalo_in_Chobe_National_Park_01.jpg
      image:
        "https://upload.wikimedia.org/wikipedia/commons/f/f4/African_buffalo_in_Chobe_National_Park_01.jpg",
      alt: "Buffalo (Syncerus caffer) dans le parc national de Chobe, Botswana",
      title: "Important Information",
      href: '/about/about-governemnt',
      description:
        "Access all the essential information and guidelines for your immigration journey in Botswana.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      id: 3,
      // Gaborone skyline — Photo : Njengabenngugi (via Wikimedia Commons)
      // Licence: CC BY-SA 4.0 — Attribution requise.
      // Source page: https://commons.wikimedia.org/wiki/File:Gaborone_skyline.JPG
      image:
        "https://upload.wikimedia.org/wikipedia/commons/5/54/Gaborone_skyline.JPG",
      alt: "Vue de la skyline de Gaborone, capitale du Botswana",
      title: "Immigration Resources",
      href: '/about/about-botswana',
      description:
        "Explore comprehensive resources to help you navigate the immigration process successfully in Botswana.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
  ...
  return (
    <section
      className="feature-section relative py-20 md:py-24 lg:py-32 bg-gradient-to-b from-gray-50 to-white overflow-hidden"
      ref={sectionRef}
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We provide comprehensive immigration services tailored to meet the
            unique needs of individuals and families in Botswana.
          </p>
        </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition-all duration-500 h-full flex flex-col relative">
                ...
                <div className="p-6 flex-grow flex flex-col">
                  <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-3 transition-colors duration-300">
                    <Link
                      href={feature.href}
                      className="block group-hover:text-[#0099cc]"
                    >
                      {feature.title}
                    </Link>
                  </h3>
                  ...
                  <div className="mt-auto flex items-center justify-between">
                    ...
                    <div
                      className={`w-12 h-0.5 bg-gray-300 transition-all duration-500 ${
