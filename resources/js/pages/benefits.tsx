        ...
        content: [
          {
            ...
            title: "Agricultural land utilization",
            content:
          ...
          {
            id: "analytical-testing-of-soil-plants-fertilisers-water-and-animal-feeds",
            title:
          ...
          {
            id: "business-plan-appraisal-for-farming",
            title: "Business Plan Appraisal for Farming",
            content:
          ...
          {
            id: "fish-farming-aquaculture-support",
            title: "Fish farming (Aquaculture) support",
            content:
          ...
          {
            id: "preparation-of-a-business-plan",
            title: "Preparation of a Business Plan",
            content:
              "Step-by-step process for developing a comprehensive business plan tailored to the agricultural sector. Includes market research, production forecasting, budgeting, risk assessment, and investment planning.",
          },
          {
            id: "project-appraisal",
            title: "Project Appraisal",
            content:
              "Guidelines for assessing agricultural projects in terms of feasibility, profitability, and social impact. Learn about cost-benefit analysis, environmental assessment, and performance monitoring for informed decision-making.",
          },
        ],
      },
      {
        ...
        content: [
          ...
          {
            id: "animal-husbandry-and-fodder-support-application",
            title: "Animal Husbandry and Fodder Support Application",
            content:
          ...
          {
            id: "animal-slaughtering",
            title: "Animal Slaughtering",
            content:
              "Guidelines for humane and hygienic animal slaughtering practices. Covers slaughterhouse standards, meat inspection protocols, and compliance with animal welfare regulations.",
          },
          {
            id: "artificial-insemination-on-farm-ai-programme",
            title: "Artificial Insemination (AI), on-farm AI programme",
            content:
              "Information on artificial insemination programs for improved breeding efficiency. Includes semen selection, handling, insemination techniques, and record-keeping for genetic improvement.",
          },
          {
            id: "brand-certificate-application",
            title: "Brand Certificate Application",
            content:
              "Process for obtaining official branding certification for livestock identification and traceability. Learn about requirements, inspection procedures, and registration protocols.",
          },
          {
            id: "bull-fertility-testing",
            title: "Bull Fertility Testing",
            content:
              "Procedures for evaluating bull fertility and reproductive performance. Covers semen testing, breeding soundness examination, and genetic evaluation to ensure herd quality.",
          },
          {
            id: "issuance-of-import-permit-of-live-animal-s-animal-product-s-and-animal-feed-s",
            title:
              "Issuance of Import Permit of Live Animal(s), Animal Product(s) and Animal Feed(s)",
            content:
              "Requirements and application process for obtaining import permits for animals and animal-derived products. Ensures compliance with veterinary health standards and biosecurity measures.",
          },
          {
            id: "issuance-of-transit-permit-for-livestock-and-livestock-products",
            title:
              "Issuance of Transit Permit for livestock and livestock products",
            content:
              "Guidelines for securing a transit permit for livestock and related products across regions. Covers documentation, inspection, and disease control measures.",
          },
          {
            id: "livestock-keeper-registration",
            title: "Livestock Keeper Registration",
            content:
              "Mandatory registration process for livestock keepers to facilitate traceability, disease control, and access to support programs. Learn about eligibility, registration requirements, and benefits.",
          },
          {
            id: "poultry-abattoir-support-application",
            title: "Poultry Abattoir Support Application",
            content:
              "Support program for establishing or upgrading poultry abattoirs. Provides guidance on infrastructure, hygiene standards, waste management, and equipment selection.",
          },
          {
            id: "user-application-for-botswana-animal-identification-and-traceability-system-baits",
            title:
              "User Application for Botswana Animal Identification and Traceability System (BAITS)",
            content:
              "Instructions for registering and using the BAITS system for animal identification and traceability. Enables accurate tracking of livestock movements and disease surveillance.",
          },
        ],
      },
      {
        ...
        content: [
          {
            ...
            title: "Application for Farm Equipment through ISPAAD Horticulture",
            content:
          ...
          {
            id: "application-for-production-inputs-support-through-ispaad-horticulture",
            title:
          ...
          {
            id: "insect-pest-identification-and-management",
            title: "Insect Pest Identification and Management",
            content:
          ...
          {
            id: "issuance-of-plant-plant-products-import-permitphytosanitary-certificate",
            title:
              "Issuance of Plant, Plant products Import Permit/Phytosanitary Certificate",
            content:
              "Procedures for obtaining phytosanitary certification and import permits for plant materials. Ensures compliance with plant health regulations and international trade standards.",
          },
          {
            id: "plant-disease-identification",
            title: "Plant Disease Identification",
            content:
              "Comprehensive overview of plant pathology and diagnostic methods. Learn how to recognize disease symptoms and apply effective prevention and treatment measures.",
          },
          {
            id: "request-for-genetic-material",
            title: "Request for Genetic Material",
            content:
              "Guidelines for requesting genetic materials such as seeds or plant varieties for research or cultivation. Includes application procedures and conditions for access.",
          },
          {
            id: "seed-testing-application",
            title: "Seed Testing Application",
            content:
              "Information on applying for seed quality testing services. Covers germination, purity, and moisture analysis to ensure compliance with national seed standards.",
          },
        ],
      },
      {
